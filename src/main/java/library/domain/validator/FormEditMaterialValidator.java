...
@Component
public class FormEditMaterialValidator implements Validator
{

	private static final Logger LOGGER = LoggerFactory.getLogger(FormEditMaterialValidator.class);
	private final MaterialService materialService;

	@Autowired
	public FormEditMaterialValidator(MaterialService materialService)
	{
	...
	{
		if (form.getOldId().equals(form.getId()))
			return;
